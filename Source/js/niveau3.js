...
function parseXMLCategories() {
	...
	var category = xmlDoc.getElementsByTagName("home");
...
function picture(animal) {
	var object = $('<div></div>');
	object.append('<img id="'+animal[1]+'" data="'+animal[4]+'" src="'+animal[1]+'" alt="image" style="position:absolute;" width="100%"/>');
	object.addClass("elem");
	object.attr("data-result",animal[4]);
